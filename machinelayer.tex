...
\begin{itemize}
  ...
  \item \tcode{noexcept} - changing the pointer argument to a reference makes it impossible to pass a \tcode{nullptr} and to get an UB. This is quite helpful for users and makes the below functions suit better the \tcode{wide_integer} needs.
\end{itemize}
\end{modifcommentblock}
