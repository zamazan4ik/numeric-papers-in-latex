...
\usepackage[pdftex,
            pdftitle={C++ Technical Specification --- Extensions for Numerics},
            pdfsubject={C++ Technical Specification --- Extensions for Numerics},
            pdfcreator={Lawrence Crowl},
            bookmarks=true,
...
%%--------------------------------------------------
%% macros specific to the Numerics TS
...
\include{intro}
\include{machinelayer}
%%\include{references}
\include{featuretest}
\include{wideinteger}
\include{rational}
\include{aliases}
\include{unboundedinteger}
\include{gentypeconv}
